...
- Source packages: 96
- Test bodies: 35
- Test assertions detected: 1161
- Registered AUnit routines detected: 214
- SPARK project files: 6
- Examples: 16

Project-local tooling uses the sibling `../project_tools` crate. Build the
checker with `gprbuild -P tools/tools.gpr` and use `tools/bin/check_all` as the
