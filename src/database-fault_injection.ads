...
--  This package is intentionally isolated from production data structures:
--  production code only observes it when explicitly wired by tests.
with Database.Status;

--  Deterministic fault-injection controls.
package Database.Fault_Injection is
