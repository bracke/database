package body Database.Full_Text.Queries is
   ...
   function Near
     (Left, Right : Wide_Wide_String;
      ...
      Q : constant Query := Make (Near_Query);
   begin
      Q.Node.L := Term (Left);
      Q.Node.R := Term (Right);
   ...
   function Fuzzy
     (Text : Wide_Wide_String;
      ...
      Q : constant Query := Make (Fuzzy_Query);
   begin
